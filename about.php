...
<body>
  ...
  <div class="content">
    ...
    <p class="content-part">
      The purpose of this application is to have the payment of the artist and the delivery of the file occur at the same time, so one cannot happen without the other.
    </p>
    <p class="content-part">
      File Buy also supports a commission system, where the seller can split the transaction into multiple milestones.
    </p>
  </div>
</body>
